...
class ChangePinView extends GetView<ChangePinController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          backgroundColor, // Background dasar yang sedikit kebiruan
      
      // APP BAR
      
      appBar: AppBar(
        backgroundColor: lightMint, // Mengikuti warna gradasi atas di desain
        elevation: 0,
        leading: IconButton(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Masukkan 6 digit PIN Anda saat ini.',
                ...
                Obx(
                  () => Row(
                    ...
                    children: List.generate(6, (index) {
                      bool isFilled =
                          index < controller.currentPin.value.length;
                      return Container(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: const Icon(
          ...
          color: Color(0xFFD32F2F), // Merah sesuai desain
          size: 24,
        ),
      ),
    );
