        ...
        child: RefreshIndicator(
          ...
          child: Obx(() => CustomScrollView(
            ...
            slivers: [
              ...
              // 2. Card Total Kekayaan (Redesigned)
              Container(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Icon(Icons.account_balance_wallet, color: greenAccent, size: 16),
                        )
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: const TextStyle(
                              ...
                              letterSpacing: -0.5, // tighter spacing for big numbers
                            ),
                          ),
                        ],
                      );
                    ...
                    Container(
                      ...
                      child: Obx(() {
                        ...
                        return Row(
                          ...
                          children: [
                            Icon(Icons.pie_chart_outline, color: greenAccent, size: 14),
                            const SizedBox(width: 8),
                            Text(
                              '$assetCount aset • $activeWalletCount rekening',
                              style: TextStyle(
              ...
              if (controller.activeTab.value == 0) ...[
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (context, index) => _buildShimmerAssetItem(),
                        childCount: 2,
                      ),
                    ),
                  )
                ...
                if (controller.isLoadingGoals.value)
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (context, index) => _buildShimmerGoalItem(),
                        childCount: 2,
                      ),
                    ),
                  )
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Batas waktu: ${goal.formattedDeadline}',
                                              style: TextStyle(
                                                fontSize: 12,
                                                color: Colors.grey[500],
                                                fontWeight: FontWeight.w500,
                        ...
                        childCount: controller.goals.length,
                      ),
                    ),
                  ),
              ],
              SliverToBoxAdapter(
                child: const SizedBox(height: 40), // Padding ekstra untuk Bottom Nav
              ),
            ],
          )),
        ),
  ...
  Widget _buildAssetItem({
    ...
    return GestureDetector(
      ...
      decoration: BoxDecoration(
        color: cardColor,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: borderColor, width: 0.8), // thinner cleaner border
      ),
      child: Row(
        children: [
          Container(
